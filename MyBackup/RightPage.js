    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View>
            <View>
              <Text style={styles.mainText}>Inside Right</Text>
            </View>
            ...
            <View style={styles.customizeContainer}>
              <View style={{width: '10%'}}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    this.sendMessageToWebRight('left');
                  }}>
                    ...
                    source={{
                      html: `<html>
                                                    ...
                                                    <body>
                                                        ...
                                                        <button id="applyfont">Apply</button>
                                                        <textarea id="fontme">Old Standard TT</textarea>
                                                            ...
                                                            $(function() {
                                                                ...
                                                                var originalRender2 = fabric.IText.prototype._initDimensions;
                                                                    ...
                                                                    this.fsize=this.fontSize;
                                                                        ...
                                                                        const textWidthUnderCursor = this._getLineWidth(this.context, this.get2DCursorLocation().lineIndex);
                                                                        console.log(textWidthUnderCursor)
                                                                        var caretPositionStart = this.selectionStart;
                                                                        var caretPositionEnd = this.selectionEnd;
                                                                        var char = String.fromCharCode(10);
                                                                        console.log(char)
                                                                        if (textWidthUnderCursor > maxW -20 && this.height<maxH-20) {
                                                                            this.insertChars(char, null, caretPositionStart, caretPositionEnd);
                                                                            this.selectionStart = caretPositionStart + char.length;
                                                                            this.selectionEnd = caretPositionStart + char.length + 1;
                                                                        }
                                                                        if (this.width > this.dynamicMinWidth) {
                                                                            this.fontSize *= this.dynamicMinWidth / (this.width + 1);
                                                                            this.width = this.dynamicMinWidth;
                                                                            this.height=  this.mheight;
                                                                        } else if(this.height<this.mheight && this.fontSize<=this.fsize){
                                                                            this.fontSize *= this.dynamicMinWidth / (this.width - 1);
                                                                            this.width = this.dynamicMinWidth;
                                                                            this.height=  this.mheight;
              ...
              <View style={{width: '10%'}}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    this.sendMessageToWebRight('back');
                  }}>

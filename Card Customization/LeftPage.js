...
class LeftPage extends Component {
  ...
  onMessage(data) {
    ...
    if ('navigateToPage' in mData) {
      if (mData.navigateToPage == 'FrontPage') {
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        $("#nextPage").click(function() {
                            var json = canvas.toJSON();
                            var svg = canvas.toSVG();
                            var datas = { "jsonfile": JSON.stringify(json), "svgfile": JSON.stringify(svg), "navigateToPage": "RightPage" };
                            window.ReactNativeWebView.postMessage(JSON.stringify(datas));
                        });
                        ...
                        $("#prevPage").click(function() {
                            var json = canvas.toJSON();
                            var svg = canvas.toSVG();
                            var datas = { "jsonfile": JSON.stringify(json), "svgfile": JSON.stringify(svg), "navigateToPage": "FrontPage" };
                            window.ReactNativeWebView.postMessage(JSON.stringify(datas));
                        });

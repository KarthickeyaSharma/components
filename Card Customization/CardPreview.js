  ...
  setsvgData = (type, skuCName) => {
    AsyncStorage.getItem('pdc_designs', (err, result) => {
      ...
      if (parseInt(index) == -1) {
        ...
        console.log(
          JSON.parse(JSON.parse(result)[index].frontPage[1].pdc_svg),
          'svg file',
        );
        if (type in JSON.parse(result)[index]) {
          if (type === 'frontPage') {
            this.setState({
              local_pdc: JSON.parse(
                JSON.parse(result)[index].frontPage[1].pdc_svg,
              ),
              svgData: JSON.parse(
                JSON.parse(result)[index].frontPage[1].pdc_svg,
              ),
            ...
            this.setState({
              local_pdc: JSON.parse(
                JSON.parse(result)[index].leftPage[1].pdc_svg,
              ),
              svgData: JSON.parse(
                JSON.parse(result)[index].leftPage[1].pdc_svg,
              ),
            ...
            this.setState({
              local_pdc: JSON.parse(
                JSON.parse(result)[index].rightPage[1].pdc_svg,
              ),
              svgData: JSON.parse(
                JSON.parse(result)[index].rightPage[1].pdc_svg,
              ),
          ...
          this.setState({
            ...
            svgData: JSON.parse(JSON.parse(result)[index].frontPage[1].pdc_svg),
            type: type,
          });
        } else {
          Alert.alert('Alert', 'No Preview Available for selected page.');

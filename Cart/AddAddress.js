  ...
  AddDetails() {
    NetInfo.fetch().then(state => {
      if (this.state.region === '') {
        ToastAndroid.show('Enter Region Name', ToastAndroid.SHORT);
      } else {
        ...
        fetch('https://haati.serverguy.cloud/rest/V1/addnewaddress/post?', {
          method: 'POST',
          headers: {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.w30}>
            <Text style={styles.mainText}>Add Address</Text>
          </View>
          <View
            style={{
              width: wp('40%'),
